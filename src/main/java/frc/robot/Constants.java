...
public final class Constants {
  ...
  public static final class Swerve {
    ...
    public static final double driveGearRatio = (50.0 / 14.0) * (17.0 / 27.0) * (45.0 / 15.0); // Default Angle Ratio
  ...
  public static final class AutoConstants {
    public static final double kMaxSpeedMetersPerSecond = 1; //was three
    public static final double kMaxAccelerationMetersPerSecondSquared = 1; //was three
